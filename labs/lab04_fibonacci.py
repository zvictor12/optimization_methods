...
from optimization_methods.one_dimensional import fibonacci_search
...
def main() -> None:
    ...
    result = fibonacci_search(parsed.f, a=0.5, b=3.5, eps=0.001)
    print_one_dim_result(result)
    figure = plot_1d_function(parsed.f, 0.5, 3.5, result.x_min)
    print(f"Plot: {save_figure(figure, 'outputs/lab04_fibonacci.png')}")
